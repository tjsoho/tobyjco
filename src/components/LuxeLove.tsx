            ...
            <Grid container direction="column" spacing={2}>
              ...
              <Grid item sx={{ height: "70%" }}>
                <Box sx={{ paddingX: "50px" }}>
                  ...
                  >
                    Luxed Love is a distinguished purveyor of second-hand luxury
                    treasures, specializing in opulent bags and timepieces.
                    <br />
                    <br /> With an unwavering commitment to luxury, Luxed Love
                    seeks to present a lavish online shopping haven,
                    spotlighting their meticulously curated selection of each
                    item.
                    <br />
                    <br />
                    To achieve this, they desire a website that seamlessly melds
                    elegance with modernity, employing a palette of Champagne
                    and rich Earthy colours, offering visitors an immersive
                    experience that reflects the brand's core values of luxury
                    and sophistication.
                  </p>
                </Box>
              </Grid>
